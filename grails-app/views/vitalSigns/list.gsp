...
<html>
	...
	<body>
		<a href="#list-vitalSigns" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-vitalSigns" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="weight" title="${message(code: 'vitalSigns.weight.label', default: 'Weight')}" />
				...
				<g:each in="${vitalSignsInstanceList}" status="i" var="vitalSignsInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: vitalSignsInstance, field: "weight")}</td>
			...
			<div class="pagination">
				<g:paginate total="${vitalSignsInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
